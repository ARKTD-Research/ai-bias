...
The introduction of the anchor consistently increased the mean sentence duration across all evaluated models. Table \ref{tab:mean_verdicts} details these shifts.
